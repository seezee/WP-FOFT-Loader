...
class WP_FOFT_Loader_Upload {
	...
	public function __clone() {
		_doing_it_wrong( __FUNCTION__, esc_html__( 'Cloning of WP_FOFT_Loader_Upload is forbidden.', 'wp-foft-loader' ), esc_attr( _VERSION_ ) );
	} // End __clone()
	...
	public function __wakeup() {
		_doing_it_wrong( __FUNCTION__, esc_html__( 'Unserializing instances of WP_FOFT_Loader_Upload is forbidden.', 'wp-foft-loader' ), esc_attr( _VERSION_ ) );
	} // End __wakeup()
