...
class WP_FOFT_Loader_Head {
	...
	public function fontload() {
		...
		echo ']).then(function () {document.documentElement.className += " fonts-stage-2";sessionStorage.criticalFoftDataUriFontsLoaded=true;}).catch(console.log.bind(console));});})();//</script>';
